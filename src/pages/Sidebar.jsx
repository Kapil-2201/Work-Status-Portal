...
const handleBtnClick =(activeBtn) =>{
      ...
      <div className="flex">
        ...
        >
          ...
          <ul className="pt-2">
            ...
            <li className={`text-gray-300 cursor-pointer text-sm flex items-center gap-x-4 p-2 ${activeBtn === 'btn2' ? 'bg-light-blue':'hover:bg-light-blue'}  rounded duration-300 mt-2`}onClick={()=>{handleBtnClick('btn2')}}
            >
              <Link to = "/tasks">
              <span className="text-2xl block float-left">
                <MdTask />
            ...
            <li
              className={`text-gray-300 cursor-pointer text-sm flex items-center gap-x-4 p-2 ${activeBtn === 'btn3' ? 'bg-light-blue':'hover:bg-light-blue'}
                rounded duration-300 mt-2`} onClick={()=>{handleBtnClick('btn3')}}
            >
              <Link to="/staffs">
              <span className="text-2xl block float-left">
                <GrUserWorker />
